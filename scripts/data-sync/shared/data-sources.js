...
export const DATA_SOURCES = {
  ...
  anaeecorp: {
    ...
    gameFilter: (gameId) => gameId.startsWith('Holdener-') || gameId.startsWith('Anaee-') || gameId.startsWith('Rigner-') || gameId.startsWith('Karnarok-') || gameId.startsWith('Botmog-'), // Only Holdener- games
    generateJoueurs: true, // Generate from game log
